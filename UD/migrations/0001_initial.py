    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Dosen_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='UD.dosen')),
                ('Mahasiswa_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='UD.mahasiswa')),
            ],
        ),
    ]
