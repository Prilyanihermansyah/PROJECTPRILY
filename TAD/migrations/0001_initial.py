    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Dosen_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='TAD.dosen')),
                ('Mahasiswa_id', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='TAD.mahasiswa')),
            ],
        ),
    ]
